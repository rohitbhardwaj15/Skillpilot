...
export function applyAssessment(profile, skill, score) { const evidenceScore=Math.max(0,Math.min(1,Number(score)/100)); const reliability=0.75; return upsertKnowledge(profile,skill,evidenceScore,`assessment score: ${score}%`,reliability); }
